		...
		<?php
			...
			if(isset($_POST['login']))
			{
				...
				if($_SERVER["REQUEST_METHOD"] == "POST")
				{
					...
					$results=mysqli_query($link,"select * from user where Username='$username' and Password='$password'") or die("failed to connect".mysqli_connect_error());
...
<div class="form reg" id="signup">
	...
	<?php
		if(isset($_POST['signup']))
		{
			...
			if($_SERVER["REQUEST_METHOD"] == "POST")
			{
				...
				{
					mysqli_select_db($link,"test_db");
					$results=mysqli_query($link,"insert into user(Username,Password) values('$usernameSub','$password1')") or die("failed to connect".mysqli_connect_error());
	...
	<form action="login.php" method="POST">
		<input class="input" type="text" name="Username" placeholder="Username" required><br>
		<input class="input" type="Password" name="Password" placeholder="Password" required><br>
		<input class="input" type="Password" name="Confirm Password" placeholder="Confirm Password" required><br>
