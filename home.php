...
<body>
	<nav class="navbar sticky-top navbar-expand-sm navbar-dark bg-dark">
    	...
    	<img src="logo.jpg" width="30" height="30" class="d-inline-block align-top" alt=""> College Predictor
  		</a>
	...
	<div class="background">
		<i class="fa fa-quote-left"></i><p>Sometimes it takes a little longer for everything to fall into place, so don’t get discouraged if something doesn’t go your way right away. It may take longer to find your place. Isn’t it true that the best things in life take time? Stay patient because it will be worth it.</p>
	</div>
	<div class="background">
		<h2>College Prediction</h2><br>
